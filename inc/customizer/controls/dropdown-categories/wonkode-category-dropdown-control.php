<?php
/**
 * Custom control for category dropdown list
 *
 * 
 * @package WonKode
 */
if ( ! class_exists( 'WonKode_Category_Dropdown_Control' ) && class_exists( 'WP_Customize_Control' ) ) :
    class WonKode_Category_Dropdown_Control extends WP_Customize_Control {
        ...
        protected function render_content() {
            ...
            <?php
                ...
                $cat_args = wp_parse_args( $this->cat_args, array(
                    'taxonomy'          =>  'category',
                    'show_option_none'  =>  esc_html__('--Select Category--', 'ras-dashen'),
                    'selected'          =>  $this->value(),
                    'show_option_all'   =>  '',
                    'orderby'           =>  'id',
                    'order'             =>  'ASC',
