...
<?php
	...
	// open woocommerce header wrapper
	WonKode_Site_Content_Area::open_section_inner_container( 'bg-primary-lightest p-0' );
?>
	<div class="row woocommerce-products-header">
		<header class="col my-2">
...
<?php
// closing woocommerce header wrapper
...
WonKode_Site_Content_Area::open_section_inner_container();
	if ( woocommerce_product_loop() ) {
		?>
		<div class="row products-data-row">
			<div class="col my-2">
			<?php
				/**
		...
		?>
		<div class="row mb-4">
			<div class="col-12 woo-pagination-col">
			<?php
				/**
